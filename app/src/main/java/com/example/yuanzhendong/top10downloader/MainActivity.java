...
public class MainActivity extends AppCompatActivity {
    ...
    private class DownloadData extends AsyncTask<String , Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            Log.d(TAG, "on post execute parameter is " + s);
...
//            ArrayAdapter<feedEntry> arrayAdapter = new ArrayAdapter<>(MainActivity.this,R.layout.list_item, parseApplications.getApplications());
        ...
        protected String doInBackground(String... strings) {
            Log.d(TAG, "downloading app starts with" + strings[0]);
        ...
        private String downloadXML(String urlPath) {
            ...
            try {
                ...
                Log.e(TAG, "downloadXML: security exception: Needs Exception:" + e.getMessage());
            }
            return null;
        }
    }
